  ...
  return (
    <div className="p-7 h-screen flex flex-col justify-between">
      ...
      <div>
        <Link
          to={"/captain-login"}
          className="bg-[#e4e47a] flex items-center justify-center text-black font-semibold mb-7 rounded px-4 py-2 border-black w-full text-lg placeholder:text-base"
        >
          Sign in as Captain
        </Link>
      </div>
